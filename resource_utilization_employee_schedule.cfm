...
<cfquery datasource="test" name="project_names">
  select name
  from project
  where charge_code = "#hours.charge_code#"
</cfquery>

<cfset names = valueList(project_names.name) />
...
<div class="col-xs-8">               
            ...
            <script>
                ...
                <form action="http://127.0.0.1:59449/resource_utilization_search_employee.cfm">
